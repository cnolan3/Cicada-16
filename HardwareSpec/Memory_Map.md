...
| E800       | EFFF     | **2 KiB**  | **System Library ROM**                                     |
...
- **Read-Only Memory:** The Cartridge ROM (`0000-7FFF`) and the System Library ROM (`E800-EFFF`) are read-only. Any attempt by the CPU to write to these regions will be blocked by the MMU and will trigger a **Protected Memory Fault**.
