...
| **<- D9-F8 ->** | **-------**    | -     | **-------**      | **---Absolute Address Load/Store---**                                                                    |
| D9-E0           | LD.b rd, (n16) | 3     | 14/16 (12 : 2/4) | `(3 bytes) => 0xD9+rd n16_lo n16_hi`. Load byte from absolute address into rd.                           |
| E1-E8           | ST.b (n16), rs | 3     | 14/16 (12 : 2/4) | `(3 bytes) => 0xE1+rs n16_lo n16_hi`. Store byte from rs to absolute address.                            |
...
| A8-AF        | DEC r        | 2     | 8 (8 : 0)         | `(2 byte) => 0xFD 0xA8+r`. Decrement r.                                         |
| B0-B7        | INC r        | 2     | 8 (8 : 0)         | `(2 byte) => 0xFD 0xB0+r`. Increment r.                                         |
